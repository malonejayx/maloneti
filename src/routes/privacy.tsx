    ...
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground">
          ...
          <Block title="6. Contact">For privacy questions, email <a className="text-primary" href="mailto:apexfxbot@gmail.com">apexfxbot@gmail.com</a> or call <a className="text-primary" href="tel:+254783719920">+254 783 719 920</a>.</Block>
        </div>
      </div>
      <Footer />
    </div>
